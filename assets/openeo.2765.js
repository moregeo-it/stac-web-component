(self["webpackChunkvue_lib_openeo"] = self["webpackChunkvue_lib_openeo"] || []).push([[2765],{
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_clonedRuleSet_22_use_0_node_modules_css_loader_dist_cjs_js_clonedRuleSet_22_use_1_node_modules_vue_vue_loader_v15_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_22_use_2_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_22_use_3_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_22_use_4_node_modules_vue_vue_loader_v15_lib_index_js_vue_loader_options_ModelBuilder_vue_vue_type_style_index_0_id_cfd84820_prod_lang_scss_shadow__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6771);
/* harmony import */ var _node_modules_vue_style_loader_index_js_clonedRuleSet_22_use_0_node_modules_css_loader_dist_cjs_js_clonedRuleSet_22_use_1_node_modules_vue_vue_loader_v15_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_22_use_2_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_22_use_3_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_22_use_4_node_modules_vue_vue_loader_v15_lib_index_js_vue_loader_options_ModelBuilder_vue_vue_type_style_index_0_id_cfd84820_prod_lang_scss_shadow__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_clonedRuleSet_22_use_0_node_modules_css_loader_dist_cjs_js_clonedRuleSet_22_use_1_node_modules_vue_vue_loader_v15_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_22_use_2_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_22_use_3_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_22_use_4_node_modules_vue_vue_loader_v15_lib_index_js_vue_loader_options_ModelBuilder_vue_vue_type_style_index_0_id_cfd84820_prod_lang_scss_shadow__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ var __WEBPACK_REEXPORT_OBJECT__ = {};
/* harmony reexport (unknown) */ for(const __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_clonedRuleSet_22_use_0_node_modules_css_loader_dist_cjs_js_clonedRuleSet_22_use_1_node_modules_vue_vue_loader_v15_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_22_use_2_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_22_use_3_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_22_use_4_node_modules_vue_vue_loader_v15_lib_index_js_vue_loader_options_ModelBuilder_vue_vue_type_style_index_0_id_cfd84820_prod_lang_scss_shadow__WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== "default") __WEBPACK_REEXPORT_OBJECT__[__WEBPACK_IMPORT_KEY__] = () => _node_modules_vue_style_loader_index_js_clonedRuleSet_22_use_0_node_modules_css_loader_dist_cjs_js_clonedRuleSet_22_use_1_node_modules_vue_vue_loader_v15_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_22_use_2_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_22_use_3_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_22_use_4_node_modules_vue_vue_loader_v15_lib_index_js_vue_loader_options_ModelBuilder_vue_vue_type_style_index_0_id_cfd84820_prod_lang_scss_shadow__WEBPACK_IMPORTED_MODULE_0__[__WEBPACK_IMPORT_KEY__]
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ ModelBuildershadow)
});

;// ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[1]!./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./components/ModelBuilder.vue?vue&type=template&id=cfd84820&shadow
var render = function render() {
  ...
  return _c('div', {
    ...
    return _c('Edge', {
      ...
      on: {
        "mounted": node => _vm.mount(edge, node),
        "unmounted": () => _vm.mount(edge),
        "position": function ($event) {
          return _vm.updateEdgePos(edge, arguments);
        }
      }
    });
  }), _vm._l(_vm.hiddenParameterRefEdges, function (edge) {
    return _c('Edge', {
      key: edge.id,
      attrs: {
        "id": edge.id,
  ...
  }), _vm.linkingLine ? _c('line', _vm._b({}, 'line', _vm.linkingLine, false)) : _vm._e(), _vm.selectRect ? _c('rect', _vm._b({}, 'rect', _vm.selectRect, false)) : _vm._e()], 2), _c('div', {
    staticClass: "blocks"
    ...
    return _c('Block', {
      ...
      on: {
        "update": (...args) => _vm.updateBlock(block, ...args),
        "mounted": node => _vm.mount(block, node),
        "unmounted": () => _vm.mount(block),
        "move": _vm.startDragBlock
      }
    });
  }), 1), _vm.state.scale < 0.7 || _vm.showZoomInfo ? _c('div', {
    staticClass: "zoomInfo"
  }, [_vm.state.scale < 0.7 ? _c('div', [_vm._v(" Zoom in for more details. ")]) : _vm._e(), _vm.showZoomInfo ? _c('div', [_vm._v(" Zoom with "), _c('kbd', [_vm._v("STRG")]), _vm._v(" or "), _c('kbd', [_vm._v("Meta")]), _vm._v(" key and the mouse wheel. ")]) : _vm._e()]) : _vm._e(), _vm.parameterViewer ? _c('ParameterViewer', _vm._b({
    on: {
      "close": function ($event) {
        _vm.parameterViewer = null;
      }
    }
  }, 'ParameterViewer', _vm.parameterViewer, false)) : _vm._e()], 1);
};
var staticRenderFns = [];

// EXTERNAL MODULE: ./components/model-builder/Block.vue + 7 modules
var Block = __webpack_require__(6914);
// EXTERNAL MODULE: ./components/model-builder/Edge.vue + 4 modules
var Edge = __webpack_require__(5218);
...
// EXTERNAL MODULE: ./node_modules/intersects/box-box.js
var box_box = __webpack_require__(1974);
var box_box_default = /*#__PURE__*/__webpack_require__.n(box_box);
// EXTERNAL MODULE: ./node_modules/intersects/box-line.js
var box_line = __webpack_require__(9985);
var box_line_default = /*#__PURE__*/__webpack_require__.n(box_line);
// EXTERNAL MODULE: ./components/model-builder/config.js
var config = __webpack_require__(7601);
;// ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[1]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./components/ModelBuilder.vue?vue&type=script&lang=js&shadow
...
const getDefaultState = function (blocks) {
  return vue_runtime_esm/* default */.Ay.observable({
    root: blocks,
    editable: false,
    compactMode: false,
    moving: null,
    ...
    selecting: null,
    // Is the user multi-selecting?
    center: [0, 0],
    mouse: [0, 0],
    scale: config/* default */.A.defaultScale,
    linkFrom: null,
    // Array
    linkTo: null // Array
  });
...
/* harmony default export */ const ModelBuildervue_type_script_lang_js_shadow = ({
  name: 'ModelBuilder',
  components: {
    Block: Block/* default */.A,
    Edge: Edge/* default */.A,
    ParameterViewer: () => Promise.all(/* import() */[__webpack_require__.e(9745), __webpack_require__.e(7082)]).then(__webpack_require__.bind(__webpack_require__, 7082))
  },
  props: {
    id: {
      type: String,
  ...
  computed: {
    ...
    classes() {
      let classes = ['vue-component', 'model-builder'];
      if (this.hasFocus) {
        classes.push('focus');
      }
      if (this.editable) {
    ...
    processRegistry() {
      ...
      if (this.processes instanceof main.ProcessRegistry || typeof this.processes.count === 'function' && typeof this.processes.get === 'function') {
        return this.processes;
      } else if (Array.isArray(this.processes)) {
        return new main.ProcessRegistry(this.processes);
      } else {
    ...
    async value(value) {
      ...
      if (!(value instanceof BlocksProcess)) {
        ...
        await this.import(value, {
          propagate: false,
          undoOnError: false
        }); // don't propagate, otherwise results in an infinite loop
      }
    },
    editable: {
      immediate: true,
  ...
  async mounted() {
    ...
    if (!(await this.import(this.value, {
      propagate: false,
      undoOnError: false
    }))) {
      this.perfectScale();
  ...
  methods: {
    ...
    updateBlockSpec(block, data) {
      ...
      let newBlock = utils/* default */.A.omitFromObject(block.spec, parameterFields);
    ...
    updateHiddenParameterRefEdges() {
      ...
      for (let process of this.processBlocks) {
        for (let argName in process.arguments) {
          ...
          let refs = src_main.Utils.getRefs(value, true, true).filter(ref => typeof ref.from_parameter !== 'undefined');
          for (let ref of refs) {
            try {
              if (!process.$el) {
                continue;
    ...
    multiSelect() {
      ...
      this.blocks.filter(b => {
        if (Array.isArray(b.position) && b.$el) {
          ...
          return box_box_default()(box.x, box.y, box.width, box.height, pos.x, pos.y, pos.width, pos.height);
        }
        return false;
      }).map(b => b.selected = true);
      this.edges.filter(e => Array.isArray(e.position1) && Array.isArray(e.position2) && box_line_default()(box.x, box.y, box.width, box.height, e.position1[0], e.position1[1], e.position2[0], e.position2[1])).map(e => e.selected = true);
    },
    toJSON() {
    ...
    async onKeyDown(event) {
      ...
      if (this.state.editable) {
        ...
        if (event.code === 'Delete') {
          ...
          // STRG for Win/Linux, meta/cmd from Mac
          if (event.code === 'KeyV') {
              ...
              if (this.clipboard.blocks.length > 0) {
                this.clipboard.blocks.forEach(block => {
                  if (block.type === 'process' && block.origin !== 'schema') {
                    this.duplicate(utils/* default */.A.pickFromObject(block, ["arguments", "description", "namespace", "position", "process_id"]));
                  } else {
    ...
    onMouseWheel(event) {
      ...
      if (!this.explicitZoom || this.hasFocus || event.ctrlKey || event.metaKey) {
        // STRG for Win/Linux, meta/cmd for Mac
    ...
    getMousePos(event) {
      ...
      return [event.clientX - root.left, event.clientY - root.top];
    },
    onMouseMove(event) {
      if (this.parameterViewer) {
        return;
    ...
    async clear() {
      return await this.startTransaction(async () => {
        ...
        this.blocks = this.blocks.filter(b => b.type === 'parameter' && utils/* default */.A.isObject(b.spec) && b.origin === 'schema');
        this.nextBlockId = 1;
        this.nextEdgeId = 1;
        this.process = {};
        this.updateHiddenParameterRefEdges();
    ...
    duplicate(data) {
      data = utils/* default */.A.deepClone(data);
      if (data.position) {
        data.position[1] += 100;
      }
    ...
    addBlock(node, id = null) {
      ...
      if (id === null && utils/* default */.A.hasText(node.process_id)) {
      ...
      block.position = utils/* default */.A.ensurePoint(block.position, () => this.getNewBlockDefaultPosition(size));
      ...
      this.blocks.push(vue_runtime_esm/* default */.Ay.observable(block));
      this.commit();
      return block;
    },
    getNewBlockDefaultPosition(blockSize) {
      var rect = this.getDimensions();
      var position = [(-this.state.center[0] + rect.width / 2) / this.state.scale - blockSize[0] / 2 + this.newBlockOffset, (-this.state.center[1] + rect.height / 2) / this.state.scale - blockSize[1] / 2 + this.newBlockOffset];
    ...
    getBlockSize(block) {
      ...
      let inputs = Math.max(utils/* default */.A.size(block.arguments), utils/* default */.A.isObject(block.spec) ? utils/* default */.A.size(block.spec.parameters) : 0);
    ...
    moveCenter(dX, dY, reset = false) {
      var rect = this.getDimensions();
      this.state.center = [(reset ? rect.width / 2 : this.state.center[0]) + dX, (reset ? rect.height / 2 : this.state.center[1]) + dY];
    ...
    selectEdge(edge, select = true, parameter = null) {
      if (!utils/* default */.A.isObject(edge)) {
    ...
    async deleteSelected() {
      ...
      return await this.startTransaction(async () => {
        ...
        for (var block of this.selectedBlocks.slice(0)) {
        ...
        for (var edge of this.selectedEdges.slice(0)) {
          // copy to avoid race condition
          this.removeEdge(edge);
        }
        return true;
    ...
    async addEdgeByNames(b1, p1, b2, p2) {
      ...
      await this.addEdge(blocks[0].getBlockParameter(p1), blocks[1].getBlockParameter(p2));
    },
    async addEdge(p1, p2) {
      if (!p1 || !p2) {
      ...
      if (!src_main.JsonSchemaValidator.isSchemaCompatible(edge.parameter2.schema || {}, edge.parameter1.schema || {}, false, true)) {
      ...
      return await this.startTransaction(async () => {
        ...
        // Create edge
        this.edges.push(vue_runtime_esm/* default */.Ay.observable(edge));
    ...
    export(internal = false) {
      ...
      for (let block of this.processBlocks) {
        ...
        let copy = utils/* default */.A.pickFromObject(block, keys);
    ...
    async import(process, options = {}) {
      return await this.startTransaction(async () => {
        ...
        if (options.clear !== false) {
          await this.clear();
          this.process = process instanceof src_main.ProcessGraph ? process.toJSON() : process;
        }
        if (!utils/* default */.A.isObject(process)) {
          return false;
        }

        // Parse process
        let pg;
        if (process instanceof src_main.ProcessGraph) {
          // Make a copy
          pg = new src_main.ProcessGraph(process.toJSON(), this.processRegistry);
          pg.setParent(process.parentProcessId, process.parentParameterName);
        } else {
          pg = new src_main.ProcessGraph(process, this.processRegistry);
        }
        pg.allowEmpty();
        pg.parse();
    ...
    async importPgParameters(params, origin, clear = true) {
      ...
      return await this.startTransaction(async () => {
        ...
        let position = [0, 0];
        for (var i in params) {
          position = [-size[0] - MARGIN, i * (size[1] + MARGIN)];
    ...
    async addPgParameter(param, origin = 'user', position = null) {
      return await this.startTransaction(async () => {
        ...
        param = utils/* default */.A.deepClone(param);
        if (typeof param.schema === 'undefined') {
          param.schema = {};
        }
        this.blocks.push(vue_runtime_esm/* default */.Ay.observable({
          id,
          type: 'parameter',
          origin,
          position: utils/* default */.A.ensurePoint(position, () => this.getNewBlockDefaultPosition(this.getBlockSize({}))),
    ...
    async importEdgeDeep(val, nodeId, arg) {
      for (let k in val) {
        ...
        } else if (!utils/* default */.A.isRef(val)) {
          continue;
    ...
    async importNodes(nodes, x = 0, y = 0, imported = []) {
      ...
      for (let node of nodes) {
        ...
        data.position = utils/* default */.A.ensurePoint(data.position, () => [x, y]);
    ...
    perfectScale() {
      ...
      for (let block of this.blocks) {
        let size = this.getBlockSize(block);
        let pos = utils/* default */.A.ensurePoint(block.position);
        if (xMin == null) {
          xMin = pos[0] - 15;
      ...
      this.state.center = [rect.width / 2 - this.state.scale * (xMin + xMax) / 2.0, rect.height / 2 - this.state.scale * (yMin + yMax) / 2.0];
      this.newBlockOffset = 0;
    },
...
;// ./components/ModelBuilder.vue?vue&type=script&lang=js&shadow
 /* harmony default export */ const components_ModelBuildervue_type_script_lang_js_shadow = (ModelBuildervue_type_script_lang_js_shadow); 
// EXTERNAL MODULE: ./node_modules/@vue/vue-loader-v15/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1656);
;// ./components/ModelBuilder.vue?shadow



function injectStyles (context) {
  
  var style0 = __webpack_require__(1940)
...
var component = (0,componentNormalizer/* default */.A)(
  components_ModelBuildervue_type_script_lang_js_shadow,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ const ModelBuildershadow = (component.exports);
...
module.exports.__inject__ = function (shadowRoot) {
  add("4a8d93ac", content, shadowRoot)
};

/***/ })

}]);
//# sourceMappingURL=openeo.2765.js.map